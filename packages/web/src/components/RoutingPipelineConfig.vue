<template>
  <div class="routing-pipeline">
    ...
    <n-card class="pipeline-stage" :bordered="false">
      <template #header>
        <div class="stage-header">
          <n-tag type="success" round size="small">Layer 1</n-tag>
    ...
    <n-card class="pipeline-stage" :bordered="false">
      <template #header>
        <div class="stage-header">
          <n-tag type="info" round size="small">Layer 2</n-tag>
...
import {
  ...
  NSlider, NSelect, NTooltip, NCollapse, NCollapseItem
} from 'naive-ui';
...
defineEmits(['update:config', 'update:classifier']);
